...
@WebServlet("/tarefaSMS")
public class TaskSmsServlet extends HttpServlet {

	private static final long serialVersionUID = 1L;

	private TarefaService tarefaService;

	public TaskSmsServlet() {
		this.tarefaService = new TarefaService(new SMSNotificacaoService());
	}
